...
Главная страница:
<ul>
  <li>поле ввода оригинальной ссылки.</li>
  <li>кнопка сгенерировать</li>
</ul>
<p>При нажатии на кнопку пользователю отдается сокращенная ссылка. Переход по ссылке редиректит на оригинальный uri.</p>
<h3>Дополнительный функционал:</h3>
<ul>
  <li>Отдача ссылки без перезагрузки страницы</li>
</ul>
